      ...
      <AppShell>
        <div className="flex max-w-2xl flex-col gap-4">
          ...
          <button
            ...
            className="w-fit rounded-lg border border-[#636366] px-6 py-3 text-sm font-semibold text-[#636366]"
          >
            Atrás
          </button>
        </div>
    ...
    <AppShell>
      <div className="pb-10">
        <div className="mb-6 flex items-center justify-between">
          <h1 className="text-[28px] font-extrabold text-black">Detalle de pago</h1>
          <button
            type="button"
            onClick={() => router.push("/PaymentHistory")}
            className="rounded-lg border border-[#636366] px-6 py-3 text-sm font-semibold text-[#636366]"
          >
            Atrás
          </button>
        </div>
