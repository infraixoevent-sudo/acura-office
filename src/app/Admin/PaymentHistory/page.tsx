...
export default function Page() {
  ...
  async function search(targetPage: number) {
    ...
    if (!selectedOrganizerId) {
      setSelectEventError("Selecciona un organizador");
      return;
    }
  ...
  function goToDetails(idTransfer: number) {
    router.push(`/Admin/PaymentHistory/PaymentDetails?idTransfer=${idTransfer}`);
  }
    ...
    <AdminShell>
      <div className="pb-10">
        <div className="mb-6 flex items-center justify-between">
          <h1 className="text-[28px] font-extrabold text-black">Historial de pagos a organizadores</h1>
          <Link
            href="/Admin/PaymentHistory/Registration-Payment-Organizer"
            className="rounded-lg bg-[#562BD2] px-6 py-3 text-sm font-semibold text-white"
          >
